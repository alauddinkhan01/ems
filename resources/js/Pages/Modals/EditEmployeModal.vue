                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option v-for="(role , index) in roles" :key="role.id" :value="role.name" >{{role.name}}</option>
                    ...
                    <div>
                        <img :src=" '/users/'+employe.image"  class="object-none h-40 w-60 border-radius: 3rem;" style="border-radius:10px" alt="">
                    </div>
                </div>
...
export default{
    props:['roles','employe','departments'],
    data(){
        return{
            title:"Add Employe",
            formObj:{
                ...
                password:'',
                confirmPassword:'',
                mobile:this.employe.mobile,
                role:this.employe.roles[0].name,
                department_id:this.employe.department.id,
                image:[]    
            },
            error:{
                name:false,
    ...
    methods:{
        submit(){
            ...
            this.axios.post(route('update.employe'),this.formObj,config).then((response)=>{
                $vfm.hide('editEmployeModal');
                this.$toast.success(
